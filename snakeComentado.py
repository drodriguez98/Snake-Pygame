...
def dibujar_pulsar_tecla():
    ...
    recta_pulsar_tecña = animacion_pulsar_tecla.get_rect()
    recta_pulsar_tecña.topleft = (ANCHO - 300, ALTO - 30)

    VENTANA.blit(animacion_pulsar_tecla, recta_pulsar_tecña)


#       FUNCIÓN QUE COMPRUEBA SI EL USUARIO PULSA ALGUNA TECLA PARA CONTINUAR.
